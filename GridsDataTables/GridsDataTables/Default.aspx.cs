    ...
    public partial class Default : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                List<Tabla> listadoTabla = new List<Tabla>();
                Tabla nuevoDato1 = new Tabla(123,"Des1",true);
                listadoTabla.Add(nuevoDato1);

                Session["Tabla"] = listadoTabla;
                //ListBind();
        ...
        {
            TaskGridView.DataSource = Session["Tabla"];
            TaskGridView.DataBind();
        }
